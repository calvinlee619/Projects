            ...
            <div class="blog-posts-masonry" id="blog-posts-masonry">
              ...
              <div class="col-sm-6 blog-item">
                <div class="blog-item-wrapper">
                  ...
                  <div class="blog-item-thumb">
                    <a href="single.html"><img src="http://dotrex.co/theme-preview/saveur-preview/img/about-picture2.jpg" alt=""></a>
                  </div>
                  <!-- /blog item thumbnail -->
                  <!-- Blog item - infos -->
                  <div class="blog-item-infos">
                    ...
                    <div class="blog-item-title-wrapper">
                      <h2 class="blog-item-title"><a href="single.html">Donec commodo lectus id sapien</a></h2>
                    </div>
                    <!-- /blog-item-title -->
                    <!-- blog item - description -->
                    <div class="blog-item-description">
                      <p><a href="single.html">Etiam quis quam libero. Lorem ipsum dolor sit amet, consectetur adipiscing  elit. la sodales, augue eget mattis hendrerit, elit sapienis gravida</a></p>
                    </div>
                    <!-- /blog-item-description -->
                    <!-- blog item - link -->
                    <div class="blog-item-link">
                      <a href="single.html" class="btn btn-default btn-rayen" data-text="See More"><span>See More</span></a>
                    </div>
                    <!-- /blog item - link -->
                  </div>
                  <!-- /blog item - infos -->
              ...
              <div class="col-sm-6 blog-item">
                <div class="blog-item-wrapper">
                  <!-- blog item thumbnail -->
                  <div class="blog-item-thumb">
                    <a href="single.html"><img src="http://dotrex.co/theme-preview/saveur-preview/img/blog4.jpg" alt=""></a>
                  </div>
                  <!-- /blog item thumbnail -->
                  <!-- Blog item - infos -->
                  <div class="blog-item-infos">
              ...
              <div class="col-sm-6 blog-item">
                <div class="blog-item-wrapper">
                  <!-- blog item thumbnail -->
                  <div class="blog-item-thumb">
                    <a href="single.html"><img src="http://dotrex.co/theme-preview/saveur-preview/img/blog3.jpg" alt=""></a>
                  </div>
                  <!-- /blog item thumbnail -->
                  <!-- Blog item - infos -->
                  <div class="blog-item-infos">
              ...
              <div class="col-sm-6 blog-item">
                <div class="blog-item-wrapper">
                  <!-- blog item thumbnail -->
                  <div class="blog-item-thumb">
                    <a href="single.html"><img src="http://dotrex.co/theme-preview/saveur-preview/img/blog2.jpg" alt=""></a>
                  </div>
                  <!-- /blog item thumbnail -->
                  <!-- Blog item - infos -->
                  <div class="blog-item-infos">
          ...
          <div class="col-md-3 col-sidebar">
            ...
            <div class="blog-sidebar">
              ...
              <div id="recent-posts-2" class="widget widget_recent_entries">
                ...
                <ul>
                  <li>
                    <a href="#">Donec commodo lectus id sapien</a>
                  </li>
                  <li>
                    <a href="#">Etiam quis quam libero. Lorem ipsum dolor sit amet</a>
                  </li>
                  <li>
                    <a href="#">Ratione voluptatem sequi nesciunt.</a>
                  </li>
                  <li>
                    <a href="#">Vel illum qui dolorem eum fugiat quo</a>
                  </li>
                  <li>
                    <a href="#">Nihil molestiae consequatur.</a>
                  </li>
                </ul>
              </div>
              <!-- /Recent Posts -->
